...
namespace Catch {
    namespace Detail {
        ...
        public:
            ...
            template<typename T, typename = typename std::enable_if<std::is_constructible<double, T>::value>::type>
            explicit
            Approx(T const &value): Approx(static_cast<double>(value)) {}
    ...
    namespace Matchers {
        ...
        namespace Vector {
            ...
            struct EqualsMatcher : MatcherBase<std::vector<T>> {
                ...
                EqualsMatcher(std::vector<T> const &comparator) : m_comparator(
                        comparator) {}
            ...
            struct UnorderedEqualsMatcher : MatcherBase<std::vector<T>> {
                UnorderedEqualsMatcher(std::vector<T> const &target) : m_target(
                        target) {}
